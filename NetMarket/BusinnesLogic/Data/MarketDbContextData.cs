    ...
    public class MarketDbContextData
    {
        public static async Task CargarDataAsync(MarketDbContext context, ILoggerFactory loggerFactory)
        {
            try
            {
                ...
                {
                    var marcaData = File.ReadAllText("../BusinnesLogic/CargarData/marca.json");
                ...
                {
                    var categoriaData = File.ReadAllText("../BusinnesLogic/CargarData/categoria.json");
                ...
                {
                    var productoData = File.ReadAllText("../BusinnesLogic/CargarData/producto.json");
